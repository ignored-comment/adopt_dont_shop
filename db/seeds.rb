...
application1 = Application.create!(name: "Kon Ham", street_address: "5714 Carmel Rd", city: "Charlotte", state: "NC", zipcode: 28226, description: "I'm a cool guy", status: "In Progress")
application2 = Application.create!(name: "Gaelyn Cooper", street_address: "123 ABC St", city: "Huntsville", state: "AL", zipcode: 35649, description: "I have many pets and have a large yard", status: "In Progress")
application3 = Application.create!(name: "Andrew Smith", street_address: "99 Bottles Rd", city: "Portland", state: "OR", zipcode: 97035, description: "I am a previous applicant and I have adopted here before", status: "In Progress")
